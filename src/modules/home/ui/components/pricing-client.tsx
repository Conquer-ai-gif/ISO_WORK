...
function PlanCard({ plan, onUpgrade, isSignedIn }: PlanCardProps) {
  ...
  return (
    <div
      className={cn(
        'relative rounded-2xl border bg-card p-6 flex flex-col gap-5 transition-shadow h-full',
        plan.highlight
...
export const PricingClient = () => {
  ...
  return (
    // ✅ FIX: removed max-w-5xl constraint that was too narrow for 3 columns
    // and added proper top padding to clear the fixed navbar
    <div className="flex flex-col w-full px-4 max-w-6xl mx-auto">
      <section className="space-y-14 pt-24 pb-20">
        ...
        {/* ✅ FIX: sm:grid-cols-3 instead of md:grid-cols-3 so 3 columns
            kick in at 640px instead of 768px, and items-stretch so all
        ...
        {/* Credit explainer */}
        <div className="rounded-xl border bg-muted/30 p-6 text-center space-y-2 w-full mt-8">
